...
- [x] **Книга модели (v1)** — движок по реестру листов: ряды, метрики, сценарии, экспорт в Excel по реестру; 13 листов: Обложка, Дорожная карта (вехи + расчётные вехи из движка), Допущения, CF (после налога), Дашборд, План продаж, CAPEX и амортизация, Опер. расходы, ФОТ (штатное расписание со взносами), ПиУ, Балансы (прогнозный баланс с тождеством Активы = Пассивы), Кредит, Ковенанты (DSCR / ICR / Долг-EBITDA против порогов; нарушения попадают и в открытые вопросы валидатора)
