...
- **Model book (v1)** — sheet-registry engine: series, metrics, scenario support, Excel export per registry; 12 sheets including Roadmap, Sales plan, CAPEX & depreciation, Opex breakdown, Headcount & payroll (with social contributions), monthly P&L with profit-tax schedules, and Covenants (DSCR / ICR / Debt-to-EBITDA vs thresholds)
...
- [x] **Книга модели (v1)** — движок по реестру листов: ряды, метрики, сценарии, экспорт в Excel по реестру; 12 листов: Обложка, Дорожная карта (вехи + расчётные вехи из движка), Допущения, CF (после налога), Дашборд, План продаж, CAPEX и амортизация, Опер. расходы, ФОТ (штатное расписание со взносами), ПиУ, Кредит, Ковенанты (DSCR / ICR / Долг-EBITDA против порогов)
